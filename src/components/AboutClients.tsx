import { Gift, Map, PackagePlus, Presentation, Verified } from "lucide-react";
...
const AboutClients = () => {
  return (
    <section className="md:px-6 px-3 py-6">
      ...
      <ul className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-16 mt-4 px-8">
        <li>
          <PackagePlus stroke="#16A34A" strokeWidth={"1.5px"} size={"50"} />
          <h5 className="text-green-600 text-xl mt-1 font-medium">
            Сборные заказы (gifts case)
          </h5>
          <ul className="flex flex-col gap-2 mt-4 text-[14px] list-disc list-inside">
            <li>Разработка для вас индивидуальных кейсов/подарочных наборов</li>
          </ul>
          <Gift
            stroke="#9333ea"
            strokeWidth={"1.5px"}
          ...
          <ul className="flex flex-col gap-2 mt-4 text-[14px] list-disc list-inside">
            <li>10% от стоимости заказа в подарок!</li>
            <li>Подарок из каталога на сумму 5000 рублей</li>
          </ul>
        </li>
        <li>
          <Presentation stroke="#FACD2B" strokeWidth={"1.5px"} size={"50"} />
          <h5 className="text-yellow-400 text-xl mt-1 font-medium">
            Персональный менеджер
          </h5>
          <ul className="flex flex-col gap-2 mt-4 text-[14px] list-disc list-inside">
            <li>
              Обслуживание клиента с учетом его персональных предпочтений и
              требований
            </li>
          </ul>
          <Verified
            ...
            size={"50"}
          />
          <h5 className="text-blue-600 text-xl mt-1 font-medium">
            Чем больше заказов, тем больше скидки
          </h5>
          <ul className="flex flex-col gap-2 mt-4 text-[14px] list-disc list-inside">
            <li>Предоставляем дополнительную скидку на заказ</li>
          </ul>
        </li>
        <li>
          <Map stroke="#dc2626" strokeWidth={"1.5px"} size={"50"} />
          <h5 className="text-red-600 text-xl mt-1 font-medium">
        ...
        <li>
          ...
          <div className="text-blue-600 text-xl font-medium mt-6 flex items-center gap-1">
            <span className="text-3xl font-medium border-[3px] border-blue-600 rounded-full flex items-center justify-center p-0.5">
              15
            </span>
            лет на рынке
          </div>
